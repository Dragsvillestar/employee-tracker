...
document.getElementById("login-form").addEventListener("submit", async (event) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById("loginInfo").textContent = "User not found in Firestore";
            document.getElementById("loginInfo").style.color = "red"; 
        }

    } catch (error) {
        console.error("❌ Login Error:", error.message);
        document.getElementById("loginInfo").textContent = error.message || "Invalid email or password";
        document.getElementById("loginInfo").style.color = "red";
    }
});
